// Yandex.Metrika — counter 108704080
...
ym(108704080,'init',{clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true});

// Market-Place / MPSU ads for chevrolet-wiki.vercel.app
// Articles only: horizontal after 1st, 5th, and 9th safe paragraphs; corner sticker
(function () {
  'use strict';
  var MPSU_SCRIPT_SRC = 'https://statika.mpsuadv.ru/scripts/11551.js';
  ...
  function initAds() {
    ...
    loadMpsuScript();
    // Rotator Static ZBT chevrolet-wiki.vercel.app горизонтальный 1 №44698
    insertAfterParagraph(44698, 1);
    // Rotator Static ZBT chevrolet-wiki.vercel.app горизонтальный 2 №44699
    insertAfterParagraph(44699, 5);
    // Rotator Static ZBT chevrolet-wiki.vercel.app горизонтальный 3 №44700
    insertAfterParagraph(44700, 9);
    // Rotator Recom V chevrolet-wiki.vercel.app №44702
    insertFloatingWidget(44702);
  }
